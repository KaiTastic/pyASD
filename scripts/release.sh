...
echo "  - If this commit was tested on TestPyPI (within 7 days): ~8 minutes"
echo "  - If not tested on TestPyPI: ~23 minutes (full test suite will run)"
echo ""
echo "Tip: Push to dev branch first to trigger TestPyPI testing before release."
echo ""
